...
<br/>
토의 내용<br>
1. 프론트 추가적인 지도 기능 구현(ex내 위치, 경로 보여주기)
2. 발표 자료 제작
...
4. 운전점수 기준 회의<br>
 내용(예정)<br>
  -급회전: 초당 변화율 120도 초과시 -10점<br>
  -급가속: 초당 1m/s이상 가속할 경우 -10점<br>
  -급감속: 초당 1m/s이상 감속할 경우 -10점<br>
  -사고: 급회전, 급가속, 급감속이 크면 사고로 판단 혹은 자이로센서를 활용한 넘어짐을 사고로 판단, -20점<br>
  -과속: 안전구역 내에서만 측정되며 과속 횟수로 -10점<br>
  -야간운전: 항목마다 1.5 배 추가 감점<br>
...
토의 내용<br>
1. 운전점수 기능 회의<br>
-운전점수 측정 방법: (기존 주행거리 x 기존 평균점수) + (새롭게 추가된 주행거리 * 새롭게 추가된 운전점수) / (총 주행거리)<br>
-운전이 끝날 때 마다 최근 운행에 대한 운전점수 출력이 아닌, 모든 운행에 대한 운전점수 출력<br>
2. 서버 회의<br>
-aws 서버 vs 스프링 서버<br>
-스프링 자체적인 서버 사용하기로 결정<br>
-핫스팟을 사용한 서버 Test<br>
3. 5/9(화)까지 포스터 준비<br>
4. 5/13(토) 킥보드 마스터 Test
...
# ☆인천대학교 컴퓨터공학부 졸업작품발표회: 킥보드 마스터 금상☆
