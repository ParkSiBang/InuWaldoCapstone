...
4. 운전점수 기준 회의
 내용(예정)
  -급회전: 초당 변화율 120도 초과시 -10점
  -급가속: 초당 1m/s이상 가속할 경우 -10점
  -급감속: 초당 1m/s이상 감속할 경우 -10점
  -사고: 급회전, 급가속, 급감속이 크면 사고로 판단 혹은 자이로센서를 활용한 넘어짐을 사고로 판단, -20점
  -과속: 안전구역 내에서만 측정되며 과속 횟수로 -10점
